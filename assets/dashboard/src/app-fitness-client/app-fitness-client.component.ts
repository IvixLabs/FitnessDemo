...
@Component({
  selector: 'app-fitness-client-root',
  templateUrl: './app-fitness-client.component.html',
  styleUrls: ['./app-fitness-client.component.scss']
})
export class AppFitnessClientComponent {

    menu: MenuMode = MenuMode.OVERLAY;
